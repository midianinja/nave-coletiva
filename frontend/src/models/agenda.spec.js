...
describe('Agenda', () => {
    ...
    it('atividade que termina no dia seguinte é quebrada em duas', () => {
        const atividade = {
            id: 1,
            nome: 'vários dias',
            inicio: 'Thu Nov 21 2019 12:00:00 GMT-0300',
            fim: 'Thu Nov 22 2019 12:00:00 GMT-0300',
            espaco: 1,
            convidades: [],
        };
        ...
        expect(agendas[1].fim.getHours()).toBe(15); // TZ
    });
    ...
    it('atividade que termina dois dias depois é quebrada em tres', () => {
        const atividade = {
            ...
            nome: 'vários dias',
            inicio: 'Thu Nov 21 2019 12:00:00 GMT-0300',
            fim: 'Thu Nov 23 2019 12:00:00 GMT-0300',
            espaco: 1,
            convidades: [],
        };
        ...
        expect(agendas[2].fim.getHours()).toBe(15); // TZ
    });
